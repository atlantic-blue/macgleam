...
struct SpaceLensMapCanvas: View {
  ...
  private func treemap(_ focused: SpaceLensTreeNode) -> some View {
  ...
  private func list(_ focused: SpaceLensTreeNode) -> some View {
    ScrollView {
