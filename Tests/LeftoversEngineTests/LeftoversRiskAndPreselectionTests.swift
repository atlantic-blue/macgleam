...
/// for every Leftovers finding: preselected only when risk is safe.
@Suite("Leftovers scan: risk and preselection")
struct LeftoversRiskAndPreselectionTests {
  ...
  @Test("no leftovers finding of any category is preselected unless its risk is safe")
