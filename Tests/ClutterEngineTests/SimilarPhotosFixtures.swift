...
// prefix so they cannot collide with fixtures from earlier Clutter slices.
...
enum SimilarPhotosFixtures {
  ...
  static func engine() -> ClutterEngine {
    ClutterEngine(userHome: home, referenceDate: referenceDate)
  }
